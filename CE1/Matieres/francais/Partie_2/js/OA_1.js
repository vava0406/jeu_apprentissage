document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Bol, Laver, Magasine, Tapis', 'Laver, Bol, Magasine, Tapis', 'Magasine, Bol, Laver, Tapis', 'Tapis, Laver, Magasine, Bol'];
    ...
    document.querySelector('.btn_valider').addEventListener('click', function () {
        ...
        reponses.forEach(function (reponse) {
            if (reponse.classList.contains('selected')) {
                ...
                if (reponse.textContent === 'Bol, Laver, Magasine, Tapis') {
        ...
        if (reponseCoSelectionnee) {
            ...
            window.location.href = 'OA_2.html';
        } else {
