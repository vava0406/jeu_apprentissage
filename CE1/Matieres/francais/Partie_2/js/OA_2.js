document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Livre, Chat, Pomme, Soleil', 'Pomme, Livre, Soleil, Chat', 'Soleil, Livre, Chat, Pomme', 'Chat, Livre, Pomme, Soleil'];
    ...
    document.querySelector('.btn_valider').addEventListener('click', function () {
        ...
        reponses.forEach(function (reponse) {
            if (reponse.classList.contains('selected')) {
                ...
                if (reponse.textContent === 'Chat, Livre, Pomme, Soleil') {
        ...
        if (reponseCoSelectionnee) {
            ...
            window.location.href = 'OA_3.html';
        } else {
