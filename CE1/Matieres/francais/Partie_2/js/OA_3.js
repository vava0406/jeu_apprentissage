document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Table, Chat, Orange, Arbre', 'Orange, Chat, Arbre, Table', 'Arbre, Chat, Orange, Table', 'Arbre, Orange, Table, Chat'];
    ...
    document.querySelector('.btn_valider').addEventListener('click', function () {
        ...
        reponses.forEach(function (reponse) {
            if (reponse.classList.contains('selected')) {
                ...
                if (reponse.textContent === 'Arbre, Chat, Orange, Table') {
        ...
        if (reponseCoSelectionnee) {
            ...
            window.location.href = 'OA_4.html';
        } else {
