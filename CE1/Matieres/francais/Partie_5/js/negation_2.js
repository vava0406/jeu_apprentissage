document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Je ne sais pas utiliser la trottinette.', 'Je ne veux pas de trottinettes.', "Hier je n'ai pas fait de trottinette.", 'Je ne peux pas faire de trottinette.'];
    ...
    document.querySelector('.btn_valider').addEventListener('click', function () {
        ...
        reponses.forEach(function (reponse) {
            if (reponse.classList.contains('selected')) {
                ...
                if (reponse.textContent === "Hier je n'ai pas fait de trottinette.") {
        ...
        if (reponseCoSelectionnee) {
            ...
            window.location.href = 'negation_3.html';
        } else {
