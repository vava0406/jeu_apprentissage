document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['(1 x 1 000) + (2 x 100) + (5 x 10) + (6 x 1)'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Decomposition_1.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Decomposition_1', formData);
      } else {
        window.location.href = 'Decomposition_2.html';
      }
    });
