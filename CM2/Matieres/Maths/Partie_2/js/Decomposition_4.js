document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['(6 x 1 000) + (7 x 100) + (8 x 10) + (2 x 1)'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Decomposition_4.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Decomposition_4', formData);
      } else {
