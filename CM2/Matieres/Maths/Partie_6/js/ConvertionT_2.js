document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['1 h 10 min'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'ConvertionT_2.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=ConvertionT_2', formData);
      } else {
        window.location.href = 'ConvertionT_3.html';
      }
    });
