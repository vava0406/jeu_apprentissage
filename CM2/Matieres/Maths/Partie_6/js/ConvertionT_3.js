document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['1 h 30 min'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'ConvertionT_3.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=ConvertionT_3', formData);
      } else {
        window.location.href = 'ConvertionT_4.html';
      }
    });
