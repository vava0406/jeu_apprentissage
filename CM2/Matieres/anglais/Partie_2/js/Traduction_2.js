document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['My cat likes to play with a ball.'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Traduction_2.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Traduction_2', formData);
      } else {
        window.location.href = 'Traduction_3.html';
      }
    });
