document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['We are going to the beach this summer.'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Traduction_3.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Traduction_3', formData);
      } else {
        window.location.href = 'Traduction_4.html';
      }
    });
