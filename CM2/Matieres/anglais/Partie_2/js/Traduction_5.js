document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['I ate a delicious pizza for dinner.'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Traduction_5.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Traduction_5', formData);
      } else {
        window.location.href = 'Traduction_6.html';
      }
    });
