document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['It\'s raining outside, so I\'m staying indoors.'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Traduction_6.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Traduction_6', formData);
      } else {
