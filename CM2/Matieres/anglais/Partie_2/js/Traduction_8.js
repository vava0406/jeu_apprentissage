document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['We visited an interesting museum yesterday.'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Traduction_8.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Traduction_8', formData);
      } else {
