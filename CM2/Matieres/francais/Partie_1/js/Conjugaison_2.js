document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Imparfait'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Conjugaison_2.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Conjugaison_2', formData);
      } else {
        window.location.href = 'Conjugaison_3.html';
      }
    });
