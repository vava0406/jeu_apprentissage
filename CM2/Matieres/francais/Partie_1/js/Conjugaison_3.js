  ...
  document.getElementById('quizForm').addEventListener('submit', function (event) {
    ...
    if (!reponseValidee) {
      ...
      if (reponseCoSelectionnee) {
        ...
        pageInput.setAttribute('value', 'Conjugaison_3.html');
    ...
    if (!reponseEnvoyee) {
      ...
      envoyerDonneesFormulaire('php/Process.php?page=Conjugaison_3', formData);
    } else {
      window.location.href = 'Conjugaison_4.html';
    }
  });
