document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Ses / sont'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Homonyme_2.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Homonyme_2', formData);
      } else {
        window.location.href = 'Homonyme_3.html';
      }
    });
