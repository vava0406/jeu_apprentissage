document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['faut / ses'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Homonyme_5.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Homonyme_5', formData);
      } else {
        window.location.href = 'Homonyme_6.html';
      }
    });
