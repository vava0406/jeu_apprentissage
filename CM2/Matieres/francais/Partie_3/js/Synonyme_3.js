    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Homonyme_3.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Synonyme_3', formData);
      } else {
        window.location.href = 'SYnonyme_4.html';
      }
    });
