document.addEventListener('DOMContentLoaded', function () {
    var syllabesCorrectes = ['Astucieux'];
    ...
    document.getElementById('quizForm').addEventListener('submit', function (event) {
      ...
      if (!reponseValidee) {
        ...
        if (reponseCoSelectionnee) {
          ...
          pageInput.setAttribute('value', 'Synonyme_4.html');
      ...
      if (!reponseEnvoyee) {
        ...
        envoyerDonneesFormulaire('php/Process.php?page=Synonyme_4', formData);
      } else {
        window.location.href = 'Synonyme_5.html';
      }
    });
