document.addEventListener('DOMContentLoaded', function () {
  var syllabesCorrectes = ['Violette'];
  ...
  function desactiverBoutonsReponse() {
    document.querySelectorAll('.btn_start_1, .btn_start_2, .btn_start_3, .btn_start_4').forEach(function (btn) {
      btn.disabled = true;
    });
  }
  ...
  document.getElementById('quizForm').addEventListener('submit', function (event) {
    ...
    if (!reponseValidee) {
      var reponses = document.querySelectorAll('.btn_start_1, .btn_start_2, .btn_start_3, .btn_start_4');
    ...
    if (!reponseEnvoyee) {
      ...
      window.location.href = 'Couleur_3.html';
    }
  });

  document.querySelectorAll('.btn_start_1, .btn_start_2, .btn_start_3, .btn_start_4').forEach(function (reponse) {
