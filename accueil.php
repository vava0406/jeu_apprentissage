...
<body>
    <div class="container">
        ...
        <h4><a class="btn_connexion" href="index.html">Accueil</a></h4>
        <button type="button" onclick="redirectToInscriptionPage()" class="btn_connexion">Déconnexion <?php session_destroy() ?> </button>
    </div> 
